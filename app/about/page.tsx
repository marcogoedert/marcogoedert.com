...
export const metadata: Metadata = {
  title: "About",
  description:
    "Software engineer obsessed with the gap between 'it works' and 'it's good.' Full stack, based in Porto Alegre, Brazil.",
};
    ...
    <div className="flex flex-col items-center gap-12 text-center w-full max-w-2xl mx-auto">
      <AnimatedSection index={0}>
        <p className="text-muted leading-relaxed max-w-prose font-mono">
          Software engineer obsessed with the gap between &ldquo;it works&rdquo;
          and &ldquo;it&apos;s good.&rdquo; I design, build, and evolve
          production systems across the full stack. Based in Porto Alegre,
          Brazil.
        </p>
      </AnimatedSection>
